...
class BILSTM_Model(object):
    ...
    def train(self, word_lists, tag_lists,
        ...
        for e in range(1, self.epoches+1):
            ...
            test_word_lists, test_tag_lists = self.test_data
            pred_tag_lists, test_tag_lists = self.test(test_word_lists, test_tag_lists, word2id, tag2id)
            try:
                metrics = Metrics(test_tag_lists, pred_tag_lists, remove_O=False)
                metrics.report_scores("Epoch {}, Val Loss:{:.4f}".format(e, val_loss))
            except Exception:
                print('tag不足')
